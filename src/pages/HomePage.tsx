...
<h1 className="text-3xl md:text-5xl font-bold text-white leading-tight slide-up">
  Pendidikan Berkualitas di SD N Pakuncen
</h1>
...
<p className="text-white/90 text-lg">
  Berikan pendidikan terbaik untuk putra-putri Anda di SD N Pakuncen. Kunjungi kami atau hubungi untuk informasi pendaftaran.
</p>
            </div>
