...
const ScannerPage: React.FC = () => {
  ...
  const startScanner = () => {
    ...
    setScanning(true); // Set scanning true immediately when starting
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="card p-5">
            ...
            <div className={`${scanning ? 'hidden' : ''} bg-gray-100 rounded-lg p-8 flex flex-col items-center justify-center text-center`}>
