...
<span className="ml-2 text-xl font-bold">SD N Pakuncen</span>
            </div>
...
<p className="ml-2 text-gray-400">Jl. Jogonegoro Ds Pakuncen, PAKUNCEN, KEC. SELOMERTO, KAB. WONOSOBO, PROV. JAWA TENGAH</p>
              </div>
...
<p className="ml-2 text-gray-400">sdnegeripakuncen@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
...
<p className="text-gray-400 text-sm">
  &copy; {new Date().getFullYear()} SD N Pakuncen. Hak Cipta Dilindungi.
</p>
        </div>
      </div>
    </footer>
